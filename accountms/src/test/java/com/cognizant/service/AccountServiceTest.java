...
class AccountServiceTest {
	...
	void getAccountTestCorrect() {
		Account account = new Account(1l, "CUST101", 3000.0, "Savings", "Jai", null);
		when(accountRepository.findByAccountId(1l)).thenReturn(account);

		assertEquals("Jai", accountServiceImpl.getAccount(1l).getOwnerName());
	}
	...
	void getCustomerAccount() {
		...
		Account account1 = new Account(1l, "CUST101", 3000.0, "Savings", "Jai ", null);
		Account account2 = new Account(2l, "CUST101", 5000.0, "Current", "Krishna", null);
	...
	void hasEmployeePermissionTest1() {
		when(authFeignClient.getValidity("token")).thenReturn(new AuthenticationResponse("EMP101", "Ram", true));
	...
	void updateBalanceTest() {
		Account account1 = new Account(1l, "CUST101", 4000.0, "Savings", "Jai", null);
		Account account2 = new Account(1l, "CUST101", 3500.0, "Savings", "Krishna", null);
